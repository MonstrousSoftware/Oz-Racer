...
import de.golfgl.gdx.controllers.ControllerMenuStage.MoveFocusDirection;
...
public class MyControllerMenuStage extends Stage {
    ...
    public MyControllerMenuStage(Viewport viewport, Batch batch) {
     ...
     */
    public MyControllerMenuStage setFocusOnTouchdown(boolean focusOnTouchdown) {
     ...
     */
    public MyControllerMenuStage setSendMouseOverEvents(boolean sendMouseOverEvents) {
                ...
                Vector2 currentActorPos = currentActor.localToStageCoordinates(
                    new Vector2(direction == MoveFocusDirection.west ? currentActor.getWidth() :
                        ...
                        direction == MoveFocusDirection.south ? currentActor.getHeight() :
                            direction == MoveFocusDirection.north ? 0 : currentActor.getHeight() / 2));
    ...
    protected float calcNeighbourDistance(MoveFocusDirection direction, Vector2 focusedPosition, Vector2
        ...
        if (direction == MoveFocusDirection.east || direction == MoveFocusDirection.west)
